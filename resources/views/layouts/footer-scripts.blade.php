...
<script type="text/javascript" src="{{ URL::asset('assets/plugins/moment/moment.min.js/daterangepicker.js') }}"></script>
...
<!-- OverlayScrollbars -->
<script type="text/javascript" src="{{ URL::asset('assets/plugins/overlayScrollbars/js/OverlayScrollbars.min.js') }}"></script>
